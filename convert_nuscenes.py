...
scene_split = ["v1.0-mini", "v1.0-trainval", "v1.0-test", "v1.0-trainval_train", "v1.0-trainval_val"]
...
if __name__ == "__main__":
    ...
    from scenarionet.converter.nuscenes.utils import convert_nuscenes_scenario, get_nuscenes_scenarios, get_nuscenes_prediction_split
